...
They treat the official Builder page as onboarding help, not final output, and normalize repo patterns such as command files in `/var/tmp` with logged-in-user handoff for root-run workflows, plus content-aware window sizing.
