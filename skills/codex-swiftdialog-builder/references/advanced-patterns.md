...
A deployment tool reads a JSON manifest of required fields and generates a swiftDialog form dynamically. Instead of building CLI arguments programmatically, it is cleaner to transform the manifest into dialog JSON and use `--jsonfile`.
